    ...
    <RichiedeAuth>
      <div className="min-h-screen">
        <header className="border-b border-ink/10 px-6 py-5">
          <Link href="/" className="text-sm text-ink-soft hover:text-ink transition-colors">← Tutti i percorsi</Link>
        </header>
...
export default PercorsoDetailClient
